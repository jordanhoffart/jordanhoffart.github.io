...
for i in range(0, number_of_elements):
    #evaluate data functions at quadrature point

    #add local entries to system matrix
    global_matrix[i,i] += 1/mesh_size
    global_matrix[i,i+1] += -1/mesh_size
    global_matrix[i+1,i] += -1/mesh_size
    global_matrix[i+1,i+1] += 1/mesh_size

    #use quadrature to add local entries to load vector
