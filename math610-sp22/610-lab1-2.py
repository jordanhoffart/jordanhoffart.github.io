#solve -(ku')' = f, u(0) = 0, u(1) = 0
#test with k(x) = 1 + x and u(x) = x*(1-x)
...
for i in range(0, number_of_elements):
    ...
    for j in range(0, number_of_quad_points):
        ...
        global_matrix[i,i] += 0 #EDIT THIS

        global_matrix[i,i+1] += 0 #EDIT THIS
        
        global_matrix[i+1,i] += 0 #EDIT THIS
        
        global_matrix[i+1,i+1] += 0 #EDIT THIS
